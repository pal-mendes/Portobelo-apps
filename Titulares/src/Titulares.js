...
// =========================
// Titulares.gs - uso duplo: spreadsheet 
// =========================
...
function CALCULAR_QUOTA(numT0, numT1, numT2, anoAtual, matrizQuotas) {
  ...
  const resultado = (numT0 * p.t0) + (numT1 * p.t1) + (numT2 * p.t2);
...
function CALCULAR_SALDO(valorPago, numT0, numT1, numT2, dataAdesaoRaw, anoAtual, matrizQuotas) {
  ...
  let saldoFinal = valorPago - devidas; // (ajuste para os nomes das suas variáveis)
  return Math.round(saldoFinal * 100) / 100;
}
// ====================================================================
